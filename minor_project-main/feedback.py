...
def feedback():
    st.title("Feedback")
    st.write("We value your feedback to help us improve Medi-Chain!")
    ...
    st.markdown("[contact.dishankpatel16082003@gmail.com](mailto:contact.dishankpatel16082003@gmail.com)")
